...
namespace CrudGeneratorTest.Controllers
{
    public class FuncionarioController : Controller
    {
        ...
        public JsonResult Get()
        {
            ...
            IList<FuncionarioTO> dados = FuncionarioDAL.Get(start, length, ref totRegistros, textoFiltro, ref totRegistrosFiltro, sortColumn, sortColumnDir);
            if (start > 0 && dados.Count == 0)
            {
                start -= length;
                dados = FuncionarioDAL.Get(start, length, ref totRegistros, textoFiltro, ref totRegistrosFiltro, sortColumn, sortColumnDir);
        ...
        [HttpPost]
        public JsonResult Insert(String Nome, String Sobrenome, Int32 Departamento)
        {
            string auxMsgErro = string.Empty;
            string auxMsgSucesso = string.Empty;

            FuncionarioTO obj = new FuncionarioTO
            {
                Nome = Nome,
                Sobrenome = Sobrenome,
            ...
            if (FuncionarioDAL.Insert(obj) == null)
            {
        ...
        [HttpPost]
        public JsonResult Update(String Nome, String Sobrenome, Int32 Departamento, Int32 Id)
        {
            string auxMsgErro = string.Empty;
            string auxMsgSucesso = string.Empty;
            ...
            if (FuncionarioDAL.Update(obj) == null)
            {
        ...
        public JsonResult Delete(Int32 Id)
        {
            ...
            if (FuncionarioDAL.Delete(obj) == null)
            {
