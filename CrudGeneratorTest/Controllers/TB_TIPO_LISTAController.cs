...
{
    public class TB_TIPO_LISTAController : Controller
    {
        ...
        public JsonResult Get()
        {
            ...
            IList<TB_TIPO_LISTATO> dados = TB_TIPO_LISTADAL.Get(start, length, ref totRegistros, textoFiltro, ref totRegistrosFiltro, sortColumn, sortColumnDir);
            if (start > 0 && dados.Count == 0)
            {
                start -= length;
                dados = TB_TIPO_LISTADAL.Get(start, length, ref totRegistros, textoFiltro, ref totRegistrosFiltro, sortColumn, sortColumnDir);
        ...
        {
            IList<object> dados = TB_TIPO_LISTADAL.GetParaChaveEstrangeira();
        ...
        public JsonResult Insert(String NOME, Int32? ID_PAI)
        {
            ...
            TB_TIPO_LISTATO obj = new TB_TIPO_LISTATO
            {
                NOME = NOME,
                ID_PAI = ID_PAI
            };

            if (TB_TIPO_LISTADAL.Insert(obj) == null)
            {
        ...
        [HttpPost]
        public JsonResult Update(String NOME, Int32? ID_PAI, Int32 ID)
        {
            string auxMsgErro = string.Empty;
            string auxMsgSucesso = string.Empty;
            ...
            if (TB_TIPO_LISTADAL.Update(obj) == null)
            {
        ...
        public JsonResult Delete(Int32 ID)
        {
            ...
            if (TB_TIPO_LISTADAL.Delete(obj) == null)
            {
